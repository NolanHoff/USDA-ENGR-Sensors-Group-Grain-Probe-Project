...
class HDC302X_Sensors:
    ...
    sensorList = [
        ("Sensor 1", "x044", hdc302x_library.HDC302X(i2c0, address=0x44)), #Sensor 1 on Bus 0
        ("Sensor 2", "x045", hdc302x_library.HDC302X(i2c0, address=0x45)), #Sensor 2 on Bus 0
        ("Sensor 3", "x046", hdc302x_library.HDC302X(i2c0, address=0x46)), #Sensor 3 on Bus 0
        ("Sensor 4", "x047", hdc302x_library.HDC302X(i2c0, address=0x47)), #Sensor 4 on Bus 0
        ("Sensor 5", "x044", hdc302x_library.HDC302X(i2c1, address=0x44)), #Sensor 5 on Bus 1
        ("Sensor 6", "x045", hdc302x_library.HDC302X(i2c1, address=0x45)), #Sensor 6 on Bus 1
        ("Sensor 7", "x046", hdc302x_library.HDC302X(i2c1, address=0x46)), #Sensor 7 on Bus 1
        ("Sensor 8", "x047", hdc302x_library.HDC302X(i2c1, address=0x47))] #Sensor 8 on Bus 1
